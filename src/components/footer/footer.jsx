          ...
          <div className="container justify-content-between">
              <div className="colum ">
                  <div className="socials-list d-flex">
                          <p href={socialMedia.Github}><i className="fa fa-github-square" aria-hidden="true" /></p>
                          <p href={socialMedia.linkedIn} target="_blank" rel="noreferrer">  <i className="fa fa-linkedin-square" aria-hidden="true" /></p>
